...
class BalTree(model.Tree):
    ...
    def insert_value(self, value):
        if self.root is None:
            ...
            self.root.values.append(BalValue(value, self.root))
        else:
            view = self.view
            ...
            self.root.insert_value(BalValue(value, None, self.root.x, self.root.y - view.y_above))
...
class BalValue(model.AnimatedObject):
...
class BalNode(model.AnimatedObject, model.Node, abc.ABC):
